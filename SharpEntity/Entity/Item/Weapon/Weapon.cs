...
namespace SharpEntity
{
    public class Weapon : IItem
    {
        ...
        #region Weapon Constructors
        public Weapon()
        {
            m_entity = new Entity("Default Weapon", 1);
            m_stats = new ItemStats();
        }
        public Weapon(String in_name, int in_level)
        {
        ...
        public Weapon(String in_name, int in_level, int in_class)
        {
            m_entity = new Entity(in_name, in_level);
            m_stats = new ItemStats();
        ...
        #region Weapon Member Functions 
        ...
        public float CalcRarity()
        {
            if (!m_entity.isRarityCalculated)
            {
                ...
                m_entity.Rarity += m_stats.Damage;
